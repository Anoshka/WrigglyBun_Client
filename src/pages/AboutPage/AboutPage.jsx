      ...
      <div className="about-page__top">
        ...
        <div className="about-page__text">
          <p className="about-page__description">
            ...
            photography as a child. Armed with a humble Kodak camera loaded with
            a 36 exposures reel, she eagerly captured moments on yearly family
            trips across India. Those trips ignited her passion for storytelling
            through images, each frame speaking volumes.
          </p>
          <p className="about-page__description">
          ...
          {/* <p className="about-page__description">
            After completing her Chartered Accountancy and spending over a
            decade in the corporate world, Anandita decided to follow her
            passion for storytelling through photography. Inspired by her
            son—the tiniest, most wriggly bundle she had ever held—WrigglyBun
            Photography was born. The name reflects both the joyful chaos of
            little ones and the journey of motherhood, from "a bun in the oven"
            to the endless movement of growing toddlers.
          </p>
          <p className="about-page__description">
            ...
            newborns, the playful charm of toddlers, and their special events
            such as birthdays, tonsure, threading ceremonies, etc. Each
            photograph is a celebration of the giggles, wriggles, and tender
            moments that families hold dear.
          </p>
          <p className="about-page__description">
          ...
          <p className="about-page__description">
            ...
            looks forward to welcoming you to her studio to turn fleeting
            moments into treasured memories.
          </p> */}
        </div>
      </div>
