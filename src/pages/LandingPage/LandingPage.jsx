    ...
    <div>
      ...
      {featured.length > 0 && (
        <section className="landing-testimonials">
          <h2 className="landing-testimonials__title">What clients say</h2>
          <div className="landing-testimonials__grid">
            {featured.map((t, i) => (
              <div key={i} className="landing-testimonial">
                {t.image && <img src={t.image} alt={t.alt} className="landing-testimonial__img" />}
                <div className="landing-testimonial__content">
                  <h3 className="landing-testimonial__name">{t.name}</h3>
                  <p className="landing-testimonial__text">&ldquo;{t.review}&rdquo;</p>
                </div>
              </div>
            ))}
          </div>
